 ...
 *
 * <p>This flow only requires authorization URL and scopes, as tokens are returned directly from the
...
public class ImplicitOAuthFlow {
  ...
  /**
   * Creates a new ImplicitOAuthFlow with required fields.
   *
   ...
   */
  public ImplicitOAuthFlow(@NotBlank String authorizationUrl, @NotNull Map<String, String> scopes) {
    this(authorizationUrl, null, scopes);
  }

  /**
   * Creates a new ImplicitOAuthFlow with all fields.
   *
   * @param authorizationUrl the authorization URL for this flow
  ...
  public ImplicitOAuthFlow(
      @NotBlank String authorizationUrl, String refreshUrl, @NotNull Map<String, String> scopes) {
   ...
   * @return a new ImplicitOAuthFlow instance
   */
  public static ImplicitOAuthFlow of(
      @NotBlank String authorizationUrl, @NotNull Map<String, String> scopes) {
    return new ImplicitOAuthFlow(authorizationUrl, scopes);
  }

  /**
   * Creates a builder for constructing ImplicitOAuthFlow instances.
   *
   * @param authorizationUrl the required authorization URL
   * @return a new builder instance
   */
  public static Builder builder(@NotBlank String authorizationUrl) {
    return new Builder(authorizationUrl);
  }

  /** Builder for constructing ImplicitOAuthFlow instances. */
  public static class Builder {
    private final String authorizationUrl;
    private String refreshUrl;
    private final Map<String, String> scopes = new HashMap<>();

    private Builder(@NotBlank String authorizationUrl) {
      this.authorizationUrl =
          Objects.requireNonNull(authorizationUrl, "authorizationUrl cannot be null").trim();
      if (this.authorizationUrl.isEmpty()) {
        throw new IllegalArgumentException("authorizationUrl cannot be blank");
    ...
    /**
     * Builds the ImplicitOAuthFlow instance.
     *
     * @return a new ImplicitOAuthFlow
     */
  ...
  public boolean equals(Object o) {
    ...
    ImplicitOAuthFlow that = (ImplicitOAuthFlow) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authorizationUrl, refreshUrl, scopes);
  }
