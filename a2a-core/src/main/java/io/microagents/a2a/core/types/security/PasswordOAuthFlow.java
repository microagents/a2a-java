 ...
 *
 * <p>This flow is typically used when the application is highly trusted and other flows are not
 * viable.
 */
public class PasswordOAuthFlow {
  ...
  /**
   * Creates a new PasswordOAuthFlow with required fields.
   *
   * @param tokenUrl the token URL for this flow
   * @param scopes the available scopes for the OAuth2 security scheme
   */
  public PasswordOAuthFlow(@NotBlank String tokenUrl, @NotNull Map<String, String> scopes) {
    this(tokenUrl, null, scopes);
  }

  /**
   * Creates a new PasswordOAuthFlow with all fields.
   *
   * @param tokenUrl the token URL for this flow
   ...
   * @return a new PasswordOAuthFlow instance
   */
  public static PasswordOAuthFlow of(
      @NotBlank String tokenUrl, @NotNull Map<String, String> scopes) {
    return new PasswordOAuthFlow(tokenUrl, scopes);
  }

  /**
   * Creates a builder for constructing PasswordOAuthFlow instances.
   *
  ...
  /** Builder for constructing PasswordOAuthFlow instances. */
  public static class Builder {
    ...
    /**
     * Builds the PasswordOAuthFlow instance.
     *
     * @return a new PasswordOAuthFlow
     */
  ...
  public boolean equals(Object o) {
    ...
    PasswordOAuthFlow that = (PasswordOAuthFlow) o;
